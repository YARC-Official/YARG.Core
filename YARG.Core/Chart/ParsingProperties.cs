...
namespace YARG.Core.Chart
{
    ...
    public enum DownchartGenerationMode
    {
        Disabled,
        MissingDifficulties,
    }
    ...
    public struct ParseSettings
    {
        ...
        public static readonly ParseSettings Default = new()
        {
            ...
            NoteSnapThreshold = 0,
            TuningOffsetCents = 0,
            DownchartGeneration = DownchartGenerationMode.Disabled,
        };
        ...
        /// <summary>
        /// Controls whether missing difficulties are generated after parsing.
        /// </summary>
        public DownchartGenerationMode DownchartGeneration;
    }
}