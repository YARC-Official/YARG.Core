        ...
        public override StemMixer? LoadAudio(float speed, double volume, params SongStem[] ignoreStems)
        {
            ...
            if (_indices.Drums.Length > 0 && !ignoreStems.Contains(SongStem.DrumsElse))
            {
                switch (_indices.Drums.Length)
                {
                    ...
                    case 3:
                        stemInfos.Add(new StemInfo(SongStem.DrumsElse, _indices.Drums[0..1], _panning.Drums[0..2]));
                    ...
                    case 4:
                        stemInfos.Add(new StemInfo(SongStem.DrumsElse, _indices.Drums[0..1], _panning.Drums[0..2]));
                        stemInfos.Add(new StemInfo(SongStem.DrumsElse, _indices.Drums[1..2], _panning.Drums[2..4]));
                    ...
                    case 6:
                        stemInfos.Add(new StemInfo(SongStem.DrumsElse, _indices.Drums[0..2], _panning.Drums[0..4]));
                        stemInfos.Add(new StemInfo(SongStem.DrumsElse, _indices.Drums[2..4], _panning.Drums[4..8]));
