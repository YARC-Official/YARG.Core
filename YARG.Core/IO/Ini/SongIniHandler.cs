    ...
    public static class SongIniHandler
    {
        ...
        static SongIniHandler()
        {
            SONG_INI_OUTLINES = new()
            {
                ...
                { "charter_bass_6f",                      new("charter_bass_6f", ModifierType.String) },
                ...
                { "charter_guitar_6f",                    new("charter_guitar_6f", ModifierType.String) },
                ...
                { "charter_rhythm",                       new("charter_rhythm", ModifierType.String) },
                { "charter_rhythm_6f",                    new("charter_rhythm_6f", ModifierType.String) },
