...
namespace StbImageSharp
{
    public static unsafe partial class StbImage
    {
        ...
        private static bool stbi__hdr_load(stbi__context* s, int* x, int* y, int* comp, stbi__result_info* ri, out FixedArray<byte> result)
        {
        ...
        private static bool stbi__hdr_to_ldr(ref FixedArray<byte> orig, int x, int y, int comp, out FixedArray<byte> result)
        {
            var i = 0;
            var k = 0;
            var n = 0;
        ...
        private static sbyte* stbi__hdr_gettoken(stbi__context* s, sbyte* buffer)
        {
            var len = 0;
            sbyte c = 0;
        ...
        private static void stbi__hdr_convert(float* output, byte* input)
        {
            if (input[3] != 0)
            {
                float f1 = 0;
