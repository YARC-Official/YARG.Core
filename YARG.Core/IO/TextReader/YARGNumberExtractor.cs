...
namespace YARG.Core.IO
{
    public static class YARGNumberExtractor
    {
        ...
        public static bool Int16<TChar>(YARGTextReader_Base<TChar> reader, out short value)
        ...
        public static bool Int32<TChar>(YARGTextReader_Base<TChar> reader, out int value)
            where TChar : IConvertible
        {
        ...
        public static bool Int64<TChar>(YARGTextReader_Base<TChar> reader, out long value)
            where TChar : IConvertible
        {
        ...
        public static bool UInt16<TChar>(YARGTextReader_Base<TChar> reader, out ushort value)
            where TChar : IConvertible
        {
        ...
        public static bool UInt32<TChar>(YARGTextReader_Base<TChar> reader, out uint value)
            where TChar : IConvertible
        {
        ...
        public static bool UInt64<TChar>(YARGTextReader_Base<TChar> reader, out ulong value)
            where TChar : IConvertible
        {
            return InternalReadUnsigned(reader, out value, ulong.MaxValue, ULONG_MAX);
        }

        public static bool Float<TChar>(YARGTextReader_Base<TChar> reader, out float value)
            where TChar : IConvertible
        {
        ...
        public static bool Double<TChar>(YARGTextReader_Base<TChar> reader, out double value)
            where TChar : IConvertible
        {
            value = 0;
        ...
        public static bool Boolean<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static short Int16<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static ushort UInt16<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static int Int32<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static uint UInt32<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static long Int64<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static ulong UInt64<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static float Float<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        public static double Double<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        private static void SkipDigits<TChar>(YARGTextReader_Base<TChar> reader)
            where TChar : IConvertible
        {
        ...
        private static bool InternalReadSigned<TChar>(YARGTextReader_Base<TChar> reader, out long value, long hardMax, long hardMin, long softMax)
            where TChar : IConvertible
        {
            value = 0;
            if (reader.Position >= reader.Next)
        ...
        private static bool InternalReadUnsigned<TChar>(YARGTextReader_Base<TChar> reader, out ulong value, ulong hardMax, ulong softMax)
            where TChar : IConvertible
        {
            value = 0;
            if (reader.Position >= reader.Next)
